...
const ForYou = () => {
    ...
    return (
      <div className=" my-12 p-4 bg-gray-200 ">
        <h1 className="text-3xl font-bold text-center mb-8 text-green-700" style={{ fontFamily: "poetsen" }}>
          Ce que nous faisons pour vous ?
        </h1>
  
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3" >
          {/* First Card */}
          <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 hover:-translate-y-2  cursor-pointer "   onClick={() => handleCardClick('/candidature')}>
            <img
